...
CREATE OR REPLACE FUNCTION s244765.update_district_totals()
RETURNS TRIGGER AS
$$
BEGIN
  BEGIN
...
AFTER INSERT OR UPDATE OR DELETE ON s244765.households
FOR EACH ROW
EXECUTE FUNCTION s244765.update_district_totals();

-- обновление полей в таблице regions
CREATE OR REPLACE FUNCTION s244765.update_region_totals()
RETURNS TRIGGER AS
$$
BEGIN
  BEGIN
...
AFTER INSERT OR UPDATE OR DELETE ON s244765.districts
FOR EACH ROW
EXECUTE FUNCTION s244765.update_region_totals();